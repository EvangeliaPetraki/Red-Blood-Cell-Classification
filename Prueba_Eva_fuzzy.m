...
% fis = addMF(fis, 'Area', 'trapmf', ...
%     [0 0 0.1*avg_area 0.2*avg_area], 'Name', 'Small');
% fis = addMF(fis, 'Area', 'trapmf', ...
%     [0.15*avg_area 0.85*avg_area 1*avg_area 2*avg_area], 'Name', 'Medium');
% fis = addMF(fis, 'Area', 'trapmf', ...
%     [1.8*avg_area 2*avg_area 2.5*avg_area 5.5*avg_area], 'Name', 'Large');
% fis = addMF(fis, 'Area', 'trapmf', ...
%     [5000 6000 7000 max(area)], 'Name', 'Very Large');

% --- Solidity ---
% fis = addInput(fis, range_solidity, 'Name', 'Solidity');
% 
% fis = addMF(fis, 'Solidity', 'trapmf', ...
%     [0 0 avg_solidity*0.6 avg_solidity*0.75], 'Name', 'Low');
% fis = addMF(fis, 'Solidity', 'trapmf', ...
%     [avg_solidity*0.7 avg_solidity*0.85 avg_solidity*1 avg_solidity*1.1], 'Name', 'Medium');
% fis = addMF(fis, 'Solidity', 'trapmf', ...
%     [avg_solidity*0.8 avg_solidity*0.95 1 1], 'Name', 'High');
...
% fis = addMF(fis, 'Eccentricity', 'trapmf', ...
%     [0 0 avg_eccentricity*0.6 avg_eccentricity*0.75], 'Name', 'Low');
% fis = addMF(fis, 'Eccentricity', 'trapmf', ...
%     [avg_eccentricity*0.7 avg_eccentricity*0.9 avg_eccentricity*1.05 avg_eccentricity*1.2], 'Name', 'Medium');
% fis = addMF(fis, 'Eccentricity', 'trapmf', ...
%     [avg_eccentricity*0.8 avg_eccentricity*0.95 1 1], 'Name', 'High');
